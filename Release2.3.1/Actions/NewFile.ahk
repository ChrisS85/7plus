Class CNewFileAction Extends CAction
{
	...
	static Filename := Vista7 ? TranslateMUI("notepad.exe",470) ".txt" : TranslateMUI("shell32.dll",8587) " " TranslateMUI("notepad.exe",469) ".txt" ;"New Textfile" ".txt"    versus   "New" "Textfile" ".txt"
	static BaseFile := ""
	static Rename := true
