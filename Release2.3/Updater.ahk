...
IniRead, ConfigPath, %A_Temp%\7plus\Update.ini, Update, ConfigPath, %A_AppData%\7plusIniRead, ScriptDir, %A_Temp%\7plus\Update.ini, Update, ScriptDir, %A_ProgramFiles%\7plusFileInstall, C:\Projekte\Autohotkey\7plus\Update.zip, Update.zip,1
...
ExitApp
SetWorkingDir %A_Temp%\7plus
IniRead, ConfigPath, %A_Temp%\7plus\Update.ini, Update, ConfigPath, %A_AppData%\7plusIniRead, ScriptDir, %A_Temp%\7plus\Update.ini, Update, ScriptDir, %A_ProgramFiles%\7plusFileInstall, C:\Projekte\Autohotkey\7plus\Update.7z, Update.7z,1
FileInstall, C:\Projekte\Autohotkey\7plus\7za.exe, 7za.exe,1
FileMoveDir, %A_Temp%\7plus\Update\Patches, %ConfigPath%\Patches, 2FileMove, %A_Temp%\7plus\Update, %ScriptDir%, 2FileDelete 7za.exe
