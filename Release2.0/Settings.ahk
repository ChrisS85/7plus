...
Settings_CreateAbout() {
	...
	yIt+=hText*2
	Gui, 1:Add, Text, y%yIt% x%x1% , Credits for lots of code samples and help go out to:`nSean, HotKeyIt, majkinetor, polyethene, Lexikos, tic, TheGood, PhiLho, Temp01, Laszlo, jballi, Shrinker, M@x`nand the other guys and gals on #ahk and the forums.	
}
